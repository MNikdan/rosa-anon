...
class RoSAProfile:
    def __init__(self, path, output_path):
        ...
        layer_file.write('layer_name;empty_rows_perc;empty_cols_perc;max_empty_perc;sparsity_perc;rows;cols\n')
        ...
        for _, name in zip(range(num_masks), list(t.keys())[1:]):
            ...
            sample_results = []
            row_col_info = f'{name};{empty_rows_perc};{empty_cols_perc};{empty_max_perc};{sparsity_perc};{rows};{cols}\n'

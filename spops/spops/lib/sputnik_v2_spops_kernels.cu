...
namespace v2 {
#include "./sputnik_v2/sputnik/sddmm/cuda_sddmm.cu.cc"
...
std::vector <torch::Tensor> sputnik_v2_sddmm_cuda_fp32_benchmark(
...
std::vector <torch::Tensor> sputnik_v2_sddmm_cuda_fp32(
	// torch::Tensor C_val, // the output values
	torch::Tensor M_row_offsets,
	torch::Tensor M_row_indices,
	torch::Tensor M_col_indices,

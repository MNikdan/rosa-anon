...
export MDL=meta-llama/Llama-2-13b-hf
export CONFIG=yamls/restart_13b_rosa_gsm_bf16.yaml
...
export RUN_NAME=13b_gsm8k-rosa_${SCHEDULE}_d${SPA_DENSITY}_${SPA_NUM_GRADS}grads_${SPA_GRAD_ACC_MODE}_r${LORA_R}_loralr${LORA_LR}_alpha${LORA_ALPHA}-lr${LR}-epochs${NUM_EPOCHS}-wu${WARMUP}-seed${SEED}-$RANDOM
...
bash eval_gsm_bf16.sh MDL=${RUN_NAME} CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES}